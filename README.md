# Inshorts-news-api
 A node package to gets news from Inshorts.
...
//user getNews for first time, it will return 25 posts and an unique id
...
[Het Delwadiya](https://www.linkedin.com/in/het-delwadiya/)
